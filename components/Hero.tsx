      ...
      <div className="mx-auto w-full max-w-6xl px-6 sm:px-8">
        <div className="grid grid-cols-1 gap-14 md:grid-cols-[1.35fr_0.65fr] md:items-stretch">
          <div className="flex flex-col gap-6 md:mt-10">
            <p className="text-[19px] text-foreground-soft">Hey 👋, I&rsquo;m Adarsh</p>

            <h1 className="font-display text-[2.5rem] leading-[1.1] text-foreground md:text-[3.25rem]">
              Security Consultant
            </h1>

            <p className="max-w-[62ch] text-[16px] leading-[1.65] text-foreground-soft">
              Security researcher and consultant specialising in web, API, and Android penetration
